...
#ifndef KERNEL_FORMAL_VERIFY_H
#define KERNEL_FORMAL_VERIFY_H
...
typedef enum
{
    ...
    FV_COND_LOOP_INVARIANT  = 3U,  /**< @brief 循环不变式条件 */
    FV_COND_TIMEOUT         = 4U,  /**< @brief 超时约束 */
    FV_COND_REENTRANT       = 5U,  /**< @brief 重入条件 */
    FV_COND_MAX_BOUNDARY    = 6U,  /**< @brief 最大边界约束 */
    FV_COND_SEQUENCE        = 7U,  /**< @brief 序列约束 */
    FV_COND_INIT_STATE      = 8U,  /**< @brief 初始状态检查 */
    FV_COND_FINAL_STATE     = 9U,  /**< @brief 终止状态检查 */
    FV_COND_RESOURCE_LEAK   = 10U, /**< @brief 资源泄漏检测 */
    FV_COND_DEADLOCK_FREE   = 11U, /**< @brief 无死锁保证 */
    FV_COND_MEMORY_SAFE     = 12U, /**< @brief 内存安全 */
    FV_COND_COUNT           = 13U, /**< @brief 计数器边界 */
    FV_COND_ORDERED         = 14U, /**< @brief 有序性 */
    FV_COND_ATOMIC          = 15U, /**< @brief 原子性 */
    FV_COND_EXCLUSIVE       = 16U, /**< @brief 互斥性 */
    FV_COND_IDEMPOTENT      = 17U, /**< @brief 幂等性 */
    FV_COND_ASSOCIATIVE     = 18U, /**< @brief 结合律 */
    FV_COND_DISTRIBUTIVE    = 19U, /**< @brief 分配律 */
    FV_COND_COMMUTATIVE     = 20U, /**< @brief 交换律 */
    FV_COND_TOTAL           = 21U  /**< @brief 总计 */
} fv_cond_type_t;
